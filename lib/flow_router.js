FlowRouter.route('/', {
	...
	action: function() {
		var description = "The bigest job board where you can easily find 100% remote jobs The fastest, easiest way to find a great 100% remote in the best companies and startups",
		title = "Remote Wolfy | Digital and Tech Remote Jobs for designers, developers and tech professionals";
		...
		BlazeLayout.render('main_page', {header: 'header', brodyga: 'brodyga' , action:'submit_job', content: 'time_table',footer:'basic_footer'});
	},
	fastRender: true
});
...
FlowRouter.route('/job/:_id', {
	...
	triggersEnter: [trackRouteEntry],
	action: function() {
		BlazeLayout.render('main_page', {header: 'header', content:'exist_job',footer:'basic_footer',action:'exist_job_apply_url'});
	},
	fastRender: true
});
...
FlowRouter.route('/post-job', {
	...
	action: function() {
		...
		BlazeLayout.render('main_page', {header: 'header', fullwidth: 'new_job',footer:'basic_footer'});
	}
});
